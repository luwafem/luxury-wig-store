...
const InstagramFeed = () => {
        ...
        const mockPosts = [
          {
            ...
            likes: 245,
            comments: 12,
            caption: 'New collection just dropped! 💫 Our 360 wigs are selling fast! #mamusca #360Wig',
            date: '2 days ago',
          ...
          },
          {
            ...
            likes: 189,
            comments: 8,
            caption: 'Customer transformation 😍 From 14 inches to 26 inches! #HairTransformation #mamusca',
            date: '4 days ago',
          ...
          },
          {
            ...
            likes: 156,
            comments: 6,
            caption: 'Summer vibes with mamusca ☀️ Perfect for beach season! #SummerHair #BeachWaves',
            date: '2 weeks ago',
  ...
  return (
    <>
      <SEO 
        title="Instagram Feed - mamusca Nigeria"
            ...
            <>
                  ...
                  <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-sm text-gray-600">#mamusca Uses</p>
                      </div>
                      <div className="text-center">
                        <div className="text-3xl font-bold text-gray-900 mb-2">
              ...
              <div className="bg-gradient-to-r from-primary-50 to-purple-50 rounded-2xl p-8 text-center">
                ...
                <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                  Use <span className="font-bold text-primary-600">#mamusca</span> for a chance to be featured on our page. 
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <a
                    href={`https://www.instagram.com/explore/tags/mamusca/`}
                    target="_blank"
                    rel="noopener noreferrer"
